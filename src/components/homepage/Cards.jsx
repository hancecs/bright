    ...
    <>
      ...
      <div className="text-center py-10">
        <h1 className="text-3xl md:text-5xl font-bold text-black">
          Campaigns that turned heads
        </h1>
      </div>

      {/* Brands Section */}
      <div className="text-center py-6">
        <h4 className="text-l md:text-2xl font-semibold text-gray-700">
          BRANDS USING OUR NETWORK
        </h4>
      </div>

      {/* Card Layout */}
      <div
        className="w-full py-20 flex flex-col lg:flex-row items-center justify-center bg-white gap-4"
      >
